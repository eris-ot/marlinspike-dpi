...
**50+ protocol dissectors. 21 anomaly detection signatures. VQT extraction for historian feed. Zero C dependencies.**
...
- **700 tests.** Unit tests for every dissector and detector. Integration tests for full-pipeline capture processing. Zero ignored, zero flaky.
